/**
 * Error Handling Utilities for Google Docs MCP Server
 *
 * Custom error classes and error handling helpers.
 */

/**
 * Base Google Docs API error
 */
 ...
 */
export class RateLimitError extends GoogleDocsApiError {
 ...
 */
export class AuthenticationError extends GoogleDocsApiError {
 ...
 * Not found error
 */
export class NotFoundError extends GoogleDocsApiError {
 ...
 * Validation error
 */
export class ValidationError extends GoogleDocsApiError {
